...
##ventana.attributes("-toolwindow",False) #oculta barra de herramientas
ventana.attributes("-topmost",100) #orden de la ventana (siempre visible)

ventana.iconbitmap("autumn.ico") #icono
